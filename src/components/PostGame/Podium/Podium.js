        ...
        <div className="podium">
          <div className="podium__second">
            <div className="podium__second--player">
              {players[1].nickname}
              <div className="podium__second--score">{players[1].score}</div>
            </div>
          ...
          <div className="podium__first">
            <div className="podium__first--player">
              {players[0].nickname}
              <div className="podium__first--score">{players[0].score}</div>
            </div>
          ...
          <div className="podium__third">
            <div className="podium__third--player">
              {players[2].nickname}
              <div className="podium__third--score">{players[2].score}</div>
            </div>
